...
INSERT INTO products (name, description, image_id, category, price, user_id, sell_count, available, ongoing_order, comment_id, click, created_at, modified_at) VALUES
('Premium Cotton T-Shirt', 'High-quality 100% cotton t-shirt with comfortable fit', 1, 'T_SHIRT', 29.99, 1, 45, TRUE, 5, NULL, 120, NOW(), NOW()),
('Classic Blue Jeans', 'Durable denim jeans with modern cut', 2, 'PANT', 79.99, 2, 23, TRUE, 2, NULL, 85, NOW(), NOW()),
('Winter Hoodie', 'Warm and cozy hoodie perfect for cold weather', 5, 'HOODIE', 49.99, 1, 31, TRUE, 3, NULL, 95, NOW(), NOW()),
('Summer Dress', 'Light and breezy dress for summer occasions', NULL, 'DRESS', 59.99, 3, 18, TRUE, 1, NULL, 67, NOW(), NOW()),
('Leather Jacket', 'Genuine leather jacket with vintage style', NULL, 'JACKET', 199.99, 4, 12, FALSE, 0, NULL, 201, NOW(), NOW());
...
INSERT INTO posts (type, content_text, content_tone, platform_ids, product_id, image_id, user_id, schedule_time, status, published_at, remarks, api_ids, created_at, modified_at) VALUES
...
-- Insert sample data into product_designs table
INSERT INTO product_designs (user_id, product_id, custom_text, font_style, text_color, text_position_x, text_position_y, preview_image_path, created_at, modified_at) VALUES
(1, 1, 'My Custom T-Shirt', 'Impact', '#FF0000', 10, 15, '/previews/design1.png', NOW(), NOW()),
(2, 2, 'Cool Jeans Design', 'Courier New', '#00FF00', 20, 25, '/previews/design2.png', NOW(), NOW()),
(1, 3, 'Winter Warmth', 'Times New Roman', '#0000FF', 30, 35, '/previews/design3.png', NOW(), NOW()),
(3, 4, 'Summer Breeze', 'Verdana', '#FFFF00', 40, 45, '/previews/design4.png', NOW(), NOW()),
(4, 5, 'Classic Leather', 'Georgia', '#FF00FF', 50, 55, '/previews/design5.png', NOW(), NOW());
...
UNION ALL
SELECT 'product_designs', COUNT(*) FROM product_designs;